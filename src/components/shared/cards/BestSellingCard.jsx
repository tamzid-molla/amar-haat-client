...
const BestSellingCard = ({ product }) => {
  const { product_image, date: created_at, product_Name, rating } = product;
  ...
  return (
    <motion.div
      ...
      <div className="flex absolute top-4 justify-between items-center mb-2">
        <span className="bg-yellow-100 text-yellow-800 flex items-center text-xs font-semibold px-2.5 py-0.5 rounded">
          {rating}
